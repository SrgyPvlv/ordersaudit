...
@Controller
public class CsvDownControllerSps {

	@GetMapping("/dateBaseToCSV/sps")
	ResponseEntity<Resource> getFileCsv() throws SQLException, IOException{
		String filename="sps.csv";
	...
	public static InputStreamResource copyToFile() throws SQLException, IOException {  
	      ...
	      String myQuery="COPY (select ppnumber,workname,unitmeasure,price,comment from sps order by ppnumber) TO STDOUT WITH (FORMAT CSV, HEADER)";
