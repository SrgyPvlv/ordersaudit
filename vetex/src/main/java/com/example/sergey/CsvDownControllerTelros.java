...
@Controller
public class CsvDownControllerTelros {

	@GetMapping("/dateBaseToCSV/telros")
	ResponseEntity<Resource> getFileCsv() throws SQLException, IOException{
		String filename="telros.csv";
	...
	public static InputStreamResource copyToFile() throws SQLException, IOException {  
	      ...
	      String myQuery="COPY (select ppnumber,workname,unitmeasure,price,comment from telros order by ppnumber) TO STDOUT WITH (FORMAT CSV, HEADER)";
