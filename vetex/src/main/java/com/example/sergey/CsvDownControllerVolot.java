...
@Controller
public class CsvDownControllerVolot {

	@GetMapping("/dateBaseToCSV/volot")
	ResponseEntity<Resource> getFileCsv() throws SQLException, IOException{
		String filename="volot.csv";
	...
	public static InputStreamResource copyToFile() throws SQLException, IOException {  
	      ...
	      String myQuery="COPY (select ppnumber,workname,unitmeasure,price,comment from volot order by ppnumber) TO STDOUT WITH (FORMAT CSV, HEADER)";
