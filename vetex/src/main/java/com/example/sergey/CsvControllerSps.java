...
@Controller
public class CsvControllerSps {

	@PostMapping("/admin/csvToDateBase/sps")
	...
	public static void copyToDateBase(MultipartFile file) throws SQLException, IOException {  
	      ...
	      String myQuery="COPY sps (ppnumber,workname,unitmeasure,price,comment) FROM STDIN WITH CSV";
